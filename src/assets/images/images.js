export const logoBlack = require('./logo/logoBlack.png');
export const logoWhite = require('./logo/logoWhite.png');
export const logoBlue = require('./logo/logoBlue.png');
...
export const noDwld = require('./noDWLD.png');
